      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-[minmax(100px,auto)] relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-6 mt-12">
             <button className="flex items-center gap-3 text-sm font-bold text-[#003329] bg-[#10B981] px-8 py-4 hover:bg-white hover:text-black transition-all hover:translate-x-1 uppercase tracking-wider">
